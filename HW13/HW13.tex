...
\begin{enumerate}
    ...
    Thus, $R_n < \displaystyle\prod_{k=1}^{n} (\dfrac{m-k+1}{k}x) = A\cdot \displaystyle\prod_{k=N}^{^n} \dfrac{m-k+1}{k}x \to 0$ as $n\to\infty$ since $\dfrac{m-k+1}{k}x < l < 1$ for all $n \geq N$.
\end{enumerate}
\end{document}