...
\begin{enumerate}
    ...
    That is, $A$ and some accumulation points of $A$, called $X = B\setminus A$ are relative open to $B$.
    But for every $x \in X$, $D(x, \epsilon)\setminus \lbrace x \rbrace \cap A \neq \emptyset \implies D(x, \epsilon) \not \subseteq X$.
    That means $X$ is not open.(contradiction).
