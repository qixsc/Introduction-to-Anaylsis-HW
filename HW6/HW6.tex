...
\begin{enumerate}
    ...
    Take open set $C_i \supseteq (V_i)^c$. \
    Since $\cap V_i = \emptyset$, $\displaystyle\bigcup_{i=1}^{\infty} C_i$ is an open cover of $V_n$ for all $n$.
    That is, $\displaystyle\bigcup_{i=1}^{\infty} C_i$ is a open cover of $\closure(V_n)$ for all $n$.
